    ...
    <div className="min-h-screen bg-brand-bg flex flex-col">
      <header className="bg-brand-bg border-b border-brand-border h-16 flex items-center px-6 sticky top-0 z-10 justify-between">
        <div className="flex items-center">
          ...
          <h1 className="text-xl font-bold text-brand-heading">My Learning Dashboard</h1>
        </div>
      ...
      <main className="flex-grow max-w-6xl w-full mx-auto p-6 space-y-8">
          ...
          <Card className="bg-white shadow-sm border-brand-border">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-brand-heading">{totalPaths}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white shadow-sm border-brand-border">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-brand-heading">{totalCoursesCompleted}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white shadow-sm border-brand-border">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-brand-heading">4</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white shadow-sm border-brand-border">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-brand-heading">3 Days</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Active Path Section */}
          <Card className="bg-white shadow-sm border-brand-border lg:col-span-2">
            <CardHeader>
              <CardTitle className="text-lg text-brand-heading">Active Learning Path</CardTitle>
            </CardHeader>
            <CardContent>
              {activePath ? (
                <div className="space-y-6">
                  <div>
                    <h3 className="font-bold text-xl text-brand-heading">{activePath.goal_name}</h3>
                  ...
                  <Button onClick={() => router.push(`/learning-path?id=${activePath.id}`)} variant="outline" className="w-full border-gray-300 text-brand-heading">
                    Continue Path
                  </Button>
                </div>
              ) : (
          ...
          <Card className="bg-white shadow-sm border-brand-border">
            <CardHeader>
              <CardTitle className="text-lg text-brand-heading">Skill Development</CardTitle>
            </CardHeader>
